...
if (isset($_SESSION['email'])) {
    ...
    $sql = "SELECT completed_appointments.*, doctors.name AS doctor_name, departments.name AS department_name 
            FROM completed_appointments 
            JOIN doctors ON completed_appointments.doctor_id = doctors.id 
            JOIN departments ON completed_appointments.department_id = departments.id 
            WHERE completed_appointments.email = '$email'";
...
<head>
    ...
    <link rel="stylesheet" href="mediRecords.css">
...
<body>
    ...
    <!-- Completed Appointments List Section -->
